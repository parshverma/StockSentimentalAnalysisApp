...
# Function to prepare the dataset (for technical features only)
...
# Function to train sentiment data separately based on sentiment values
...
movement_technical, movement_sentiment, explanation = predict_stock_movement('2024-09-2', testHeadline, testSummary, 214.11)
